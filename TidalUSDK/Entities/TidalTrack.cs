...
namespace TidalUSDK.Entities {
    public class TidalTrack {
        ...
        /// <summary>
        /// ReplayGain is a track metric used for consistent volume leveling of tracks that are not on the same album (e.g. shuffling).
        /// Not typically applied if each track in a queue is from the same album to respect the album's mastering, but some clients allow you to override this.
        /// </summary>
        /// <remarks>
        /// Json.NET does something very odd with decimals, so we have to round to TIDAL's base decimal accuracy, hence the backing field...
        /// </remarks>
