...
namespace SacredSkull.TidalUSDK.Entities
{
    public class TidalPlaylist
    {
        ...
        [JsonProperty("type")] public TidalPlaylistType Type { get; set; }

        [JsonProperty("publicPlaylist")] public bool Public { get; set; }

        [JsonProperty("url")] public string Url { get; set; }

        [JsonProperty("popularity")] public int Popularity { get; set; }

        [JsonProperty("squareImage")] public Guid? Cover { get; set; }
        ...
        public class TidalPlaylistCreator
        {
            ...
            [JsonProperty("picture")] public Guid? Cover { get; set; }
